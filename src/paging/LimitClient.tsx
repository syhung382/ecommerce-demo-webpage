...
const dropdownValue = [12, 18, 24, 30];

const LimitClient = ({ limit, handleSelectLimit }: LimitProps) => {
  ...
  return (
    <div>
      <div ref={dropdownRef} className="relative ml-2 inline-block w-full">
        <div
          className={`flex items-center justify-between py-1 px-2 dark:bg-gray-800 bg-blue-50 border dark:border-gray-500 border-gray-300 rounded-lg cursor-pointer font-medium text-[15px] hover:border-blue-300 `}
